...
```{r get data w interpolated}

# ETS / ARIMA models does not allow NAs
# 
# allways only the the count column is used 
...
fit_ets_aut <- filter(data_monthly, 
...
# calculate forecasts
fc_arima_all <- fit_arima_all %>% fabletools::forecast(h = forecast_horison) 
# long running
...
```{r compare residual and forecast accuracy, eval = eval_ets_arima}
...
```{r Ljung-Box Test ETS Arima, eval = eval_ets_arima}
