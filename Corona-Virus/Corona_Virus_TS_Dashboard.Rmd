...
data %<>% rename(Daily_Conf_rol_mean = Conf_mp7d,
                 Daily_Deaths_rol_mean = Deaths_mp7d) 
...
data_xts <- xts::xts(
  data %>% dplyr::select(Daily_Confirmed, Daily_Conf_rol_mean, 
                         Daily_Deaths, Daily_Deaths_rol_mean),
  order.by = index)
