...
case_type <- "Confirmed"
title <- paste(case_type, "- Cumulated Cases / Country")
world_map_plot(
  filter(corona_data_last, Case_Type == case_type & Country != "World"), 
...
# plot total confirmed in world
case_type <- "Confirmed"
title <- paste(case_type, "- Cumulated Cases / 100k / Country")
world_map_plot(
  filter(corona_data_last, Case_Type == case_type & Country != "World"), 
...
case_type <- "Confirmed"
abscissa <- "Cases"
title <- paste(case_type , "- Cumulated Cases")
bar_chart_country(
  filter(corona_data_last, Country != "World" & Case_Type == case_type),
  y = abscissa, title = title, n = 15)
# for cumulated cases world = sum of all => filter out
...
title <- paste(case_type , 
               "- Cumulated Cases / 100k")
bar_chart_country(
  filter(corona_data_last, Case_Type == case_type),
  y = abscissa, title = title, n = 15)
...
bar_chart_country(cfr_table, y = abscissa, title = title, n = 20)
...
bar_chart_country(filter(cfr_table, 
