...
```{r}
corona_population_last_wide <- corona_all_wide %>%
...
DT::datatable(corona_last_abs_wide, options = list(pageLength = 50))
...
DT::datatable(corona_last_rel_wide, options = list(pageLength = 50))
...
DT::datatable(cfr_table, options = list(pageLength = 10))
