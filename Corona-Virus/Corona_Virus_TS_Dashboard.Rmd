...
```{r setwd change, eval = TRUE}

setwd(dirname(rstudioapi::getSourceEditorContext()$path))
# setwd() not needed for knit run: changes working dir => path of *.RMD file 
# setwd() needed for R code run for relative source() paths

source("./Corona_raw_data.R") # provides function to read and process the 
      # raw time series data of the John Hopkins University Corona Hopkins
